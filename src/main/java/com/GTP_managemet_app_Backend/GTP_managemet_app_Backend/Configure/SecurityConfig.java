    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.cors(cors -> cors.configurationSource(request -> {
                ...
                .authorizeHttpRequests(request -> request
                        ...
                        .permitAll()
                        .requestMatchers("/api/admin/trainers","/api/admin/trainees","/api/admin/ratio","/api/admin/specializations")
                        .permitAll()
                        .requestMatchers("/api/project/create","/api/project/projects/{projectId}","/api/project/projects/{projectId}","/api/project/projects/{projectId}/assign")
                        .permitAll()
                        .anyRequest()
                        .authenticated())
