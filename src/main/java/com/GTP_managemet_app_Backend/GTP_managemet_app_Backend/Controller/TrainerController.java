...
public class TrainerController {
    ...
    @PostMapping("/invite")
    public ResponseEntity<?> inviteStudent(@RequestParam("name") String name, @RequestParam("email") String email) {
        try {
            User invitedUser = userServiceImplementation.inviteUser(name, email, Role.TRAINEE);
